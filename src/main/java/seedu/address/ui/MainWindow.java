...
public class MainWindow extends UiPart<Stage> {
    ...
    void fillInnerParts() {
        ...
        personNoteAreaPlaceholder.visibleProperty().bind(personNoteArea.getRoot().visibleProperty());
        personNoteAreaPlaceholder.managedProperty().bind(personNoteArea.getRoot().visibleProperty());
